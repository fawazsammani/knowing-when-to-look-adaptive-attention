...
If you want to do evaluation on COCO, make sure to download the COCO API from [here](https://github.com/cocodataset/cocoapi) if your on Linux or from [here](https://github.com/philferriere/cocoapi). Then download the COCO caption file from [here](https://github.com/tylin/coco-caption) or just uses the file included in this repository. Don't forget to download java as well. Simply dowload it from [here](https://www.java.com/en/download/) if you don't have it. 
