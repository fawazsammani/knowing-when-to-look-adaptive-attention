    ...
    def forward(self, spatial_image, global_image, encoded_captions, caption_lengths, enc_image):
        ...
        for timestep in range(max(decode_lengths)):
            ...
            if begining_lstm:
                ...
                # First, keep a copy of the hidden and cell state since we need to pass them to the sentinal later. 
                h_prev = h.clone()
                c_prev = c.clone()
            ...
            if begining_sen:
                ...
                st = self.sentinal(current_input, h_prev[:batch_size_t], c_prev[:batch_size_t])
